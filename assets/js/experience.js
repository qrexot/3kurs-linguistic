...
window.UI=(()=>{
 ...
 let initialList=true,restoreFrame=0,readerId=null,readerMode=null,readingReady=false,readerTimer;
 ...
 window.addEventListener('scroll',()=>{if(readerId){progress();clearTimeout(readerTimer);readerTimer=setTimeout(saveReader,180)}},{passive:true});
 ...
 return {listState,restoreList,listRendered,announce,skeleton,ready,readerRendered};
})();
